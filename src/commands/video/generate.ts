...
export const generateCommand: Command = {
  ...
  options: [
    ...
    { flag: '--model <id>', description: 'Model ID (e.g. agnes-video-v2.0, veo3.1). Default from config' },
    { flag: '--seconds <n>', description: 'Video duration in seconds. Default from config', type: 'number' },
    { flag: '--size <WxH>', description: 'Video size (e.g., 1280x720)' },
    { flag: '--resolution <p>', description: 'Resolution: 480p, 720p, 1080p, 4k. Default from config' },
